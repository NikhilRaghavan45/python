        ...
        return (
            <div className="container mt-5">
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card">
                            <img src={saree1} className="card-img-top" alt="Product Image" />
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={saree2} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={saree3} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={saree4} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={saree5} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={saree6} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={saree7} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={lehanga1} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={lehanga2} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={lehanga3} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={lehanga4} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={jeans1} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={jeans2} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={jeans3} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={jeans4} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={hood1} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={hood2} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={hood3} className="card-img-top" alt="Product Image" />
                            <div className="card-footer bg-danger text-white">
